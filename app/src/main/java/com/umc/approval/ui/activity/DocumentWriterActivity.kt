...
import com.umc.approval.databinding.ActivityDocumentWriterBinding
...
class DocumentWriterActivity : AppCompatActivity() {
    private lateinit var binding : ActivityDocumentWriterBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityDocumentWriterBinding.inflate(layoutInflater)
